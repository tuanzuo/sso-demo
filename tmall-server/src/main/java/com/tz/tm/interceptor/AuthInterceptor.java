package com.tz.tm.interceptor;

import com.tz.tm.util.CookieUtils;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    private String tmHost = "www.tm.com";
    private String tmUrl = "http://www.tm.com:8083/";
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        for (String urlPre : urlPreList) {
            if (requestURI.contains(urlPre) && StringUtils.isBlank(userToken)) {
                response.sendRedirect(ssoUrl + "/login?redirect=" + tmUrl +"&fromServer="+ tmUrl);
                return false;
            }
        }
        return true;
